...
<?php if ($text): ?>
    <div data-orientation="{{ $orientation }}" class="flex items-center w-full {{$class}}" role="none" data-flux-separator>
...
<?php else: ?>
    <div data-orientation="{{ $orientation }}" role="none" {{ $attributes->class($classes, 'shrink-0 ', $class) }} data-flux-separator></div>
<?php endif; ?>
