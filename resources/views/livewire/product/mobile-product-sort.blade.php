<div>
    <div class="sm:hidden relative" x-data="{open: false}">
        ...
        <div
            ...
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="desc:product_name"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Name (cba)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent hover:text-black transition-all cursor-pointer" data-value="asc:product_name"
