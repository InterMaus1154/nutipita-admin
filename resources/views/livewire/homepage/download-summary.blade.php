...
<div class="flex relative" x-data="{menuOpen: false}">
    ...
    <div class="absolute top-8 z-50 border-2 border-neutral-700 rounded-xl bg-zinc-800 p-2 flex flex-col gap-6 min-w-[350px]" x-show="menuOpen" x-on:click.outside="menuOpen = false" x-cloak>
