<div class="space-y-4">
    <div class="flex flex-col gap-4 items-start">
        ...
        <div class="flex gap-2 flex-wrap">
            <flux:button wire:click="setYear">This Year</flux:button>
            <flux:button wire:click="setMonth">This Month</flux:button>
            <flux:button wire:click="setWeek">This Week</flux:button>
