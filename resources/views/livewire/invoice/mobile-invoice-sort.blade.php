<div>
    <div class="sm:hidden relative" x-data="{open: false}">
        ...
        <div
            ...
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="desc:invoice_number"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Invoice Number (cba)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="asc:invoice_number"
            ...
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="asc:invoice_issue_date"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Issue Date (abc)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="desc:invoice_due_date"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Due Date (cba)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="asc:invoice_due_date"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Due Date (abc)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="desc:invoice_total"
                  wire:click="setMobileSort($event.target.getAttribute('data-value'))" x-on:click="open = false">Invoice Total (cba)</span>
            <span class="py-1 px-1 rounded-sm hover:bg-accent/90 hover:text-black transition-all cursor-pointer" data-value="asc:invoice_total"
