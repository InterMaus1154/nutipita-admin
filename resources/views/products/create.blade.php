    ...
    <div class="form-wrapper">
        ...
        <form action="{{route('products.store')}}" method="POST">
            ...
            <div class="input-wrapper">
                ...
                <input type="number" id="product_unit_price" name="product_unit_price" value="{{old('product_unit_price', '')}}" step=".01"/>
            </div>
            {{--Product pack price--}}
            <div class="input-wrapper">
                <label for="product_pack_price">Product pack price (optional)</label>
                <input type="number" id="product_pack_price" name="product_pack_price" value="{{old('product_pack_price', '')}}" step=".01"/>
            </div>
            {{--Product weight--}}
            <div class="input-wrapper">
