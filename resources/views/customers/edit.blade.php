        ...
        <form action="{{route('customers.update', compact('customer'))}}" method="POST" class="flex flex-col gap-4">
            ...
            <div class="max-w-sm">
                <x-form.form-wrapper>
                    ...
                    <x-form.form-input type="text" id="customer_business_owner_name" name="customer_business_owner_name" value="{{$customer->customer_business_owner_name}}" placeholder="Business Owner Name"/>
                </x-form.form-wrapper>
            </div>
            {{--Customer address--}}
            <div class="max-w-sm">
            ...
            <div class="hidden">
                ...
                <input type="hidden" id="customer_country" name="customer_country" value="United Kingdom" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
            </div>
            {{--Customer email--}}
            <div class="max-w-sm">
