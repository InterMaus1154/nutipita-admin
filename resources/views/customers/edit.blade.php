<x-flux-layout>
    <x-page-section>
        ...
        <form action="{{route('customers.update', compact('customer'))}}" method="POST" class="flex flex-col gap-4">
            ...
            {{--Customer address--}}
            <x-form.form-wrapper center="true">
                <label for="customer_address_1" class="block text-sm font-medium mb-2 dark:text-white">Address Line 1
                </label>
            ...
            <x-form.form-wrapper center="true">
                <label for="customer_address_2" class="block text-sm font-medium mb-2 dark:text-white">Address Line 2
                    (optional)
                </label>
            ...
            {{--Customer email--}}
            <x-form.form-wrapper center="true">
                <label for="customer_email" class="block text-sm font-medium mb-2 dark:text-white">Email (optional)
                </label>
