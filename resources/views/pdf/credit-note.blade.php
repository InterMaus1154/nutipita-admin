        ...
        <table class="header-table" style="width: 100%; table-layout: fixed; border-collapse: collapse">
            <tr>
                ...
                <td class="text-center">
                    <div style="font-size: 32px; font-weight: bold;">CREDIT NOTE</div>
                </td>
                <!-- Company Data -->
                ...
                <td class="text-right">
                    <table class="invoice-detail-table">
                        ...
                        <tr>
                            ...
                            <td>{{Carbon::parse($creditNote->credit_note_issued_at)->format('d/m/Y')}}</td>
                        </tr>
                    </table>
                ...
                @foreach($products as $invoiceProduct)
                    <tr>
                        ...
                        <td class="col-description">
                            <span
                                class="product-data-name">{{$invoiceProduct->product->product_name}} {{$invoiceProduct->product->product_weight_g}}g</span>
                            <br>
                        ...
                        <td class="col-amount">
                            <span
                                ...
                                @moneyFormat($invoiceProduct->product_qty * $invoiceProduct->product_unit_price)
                            </span>
                            <br>
                            <span
                                class="product-data-desc">{{amountFormat($invoiceProduct->product_qty)}} x @unitPriceFormat($invoiceProduct->product_unit_price)</span>
                        </td>
                    </tr>
                    @php
                        $i++;
